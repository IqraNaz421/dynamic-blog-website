...
const Design = () => {
  ...
  const [comments, setComments] = useState([
    { name: "Hina", text: "Amazing insights into design trends! I feel inspired" },
    { name: "Kamran", text: "Love the minimalist designs you mentioned Great article!" },
    { name: "Alina", text: "Can you cover more on UI/UX for mobile apps?" },
  ]);
