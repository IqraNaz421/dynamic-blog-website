...
//             <h2 className="text-4xl font-bold text-blue-900">{post.title}</h2> <br />
...
//   const posts: Post[] = [
//     {
//       title: 'Project 1 - Ice Cream Website',
//      date: 'Nov 17, 2024',
//     content: `Explore the Sweet World of Ice Cream!
//     Ice cream is more than just a dessert—its an experience! In this project I delved into the deliciously creative world of ice cream crafting a design that reflects the cool and refreshing vibes of everyones favorite treat 🍨 
// 🌟 Key Highlights of the Project:
//  Visually Appealing Design: A sleek and modern interface featuring tempting ice cream graphics  
//  Interactive User Experience: 
//    - Smooth animations for a playful experience  
//    - Responsive layout that works seamlessly on all devices  
//  Professional Touch: 
//    Integrated a blog-style layout with an elegant design showcasing ice cream varieties and their history  
//  Tech Stack:
...
//     },
//   {
//       title: 'Project 5 - Resume Builder',
//      date: 'Nov 21, 2024',
